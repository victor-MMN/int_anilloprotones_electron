...
WRITE(*,*)'   ===================================================== '
WRITE(*,*)'    '
WRITE(*,*)'   Se modelara un anillo cargado uniformemente como un ' 
WRITE(*,*)'   conjunto de cargas puntuales colocadas en un circulo.' 
WRITE(*,*)'   El anillo fue colocado en el plano yz de manera que ' 
WRITE(*,*)'   eje coincida con el eje de las x.'
WRITE(*,*)'   Se asigno una carga total Q = 50 nC y un radio '
WRITE(*,*)'   de R = 0.1 m. '
WRITE(*,*)'    '
WRITE(*,*)'   ====================================================='
WRITE(*,*)'   '
...
!IMAGEN
	OPEN(20,FILE="dibujar.plt",STATUS="UNKNOWN")
		...
		WRITE(20,*)'set xlabel "x" offset -4, -0.5, 0'
		WRITE(20,*)'set ylabel "y" offset -4, -1.8, 0'
      WRITE(20,*)'set zlabel "z" offset 2.5, 0, 0'
      WRITE(20,*)'set terminal png'
      ! WRITE(20,*)'set view 65,30,1'
      WRITE(20,*)'set output "trayectoria.png"'
      WRITE(20,*)'set xtics left offset 0,-0.6 rotate by 45 right'
